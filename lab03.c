...
void MainWndAddMenu(HWND hwnd)
{
    ...
    AppendMenu(SubMenu, MF_STRING, ON_SAVE,"Сохранить");
    AppendMenu(SubMenu, MF_STRING, OnMenu2Clicked, "Открыть");
    AppendMenu(SubMenu2, MF_STRING, OnMenu3Clicked, "О программе");
    AppendMenu(SubMenu3, MF_STRING, ON_COPY, "Копировать");
    AppendMenu(SubMenu3, MF_STRING, ON_PASTE, "Вставить");
    AppendMenu(SubMenu3, MF_STRING, ON_CUT, "Вырезать");
    AppendMenu(RootMenu, MF_POPUP, (UINT_PTR)SubMenu, "Файл");
    AppendMenu(RootMenu, MF_POPUP, (UINT_PTR)SubMenu2, "Справка");
    AppendMenu(RootMenu, MF_POPUP, (UINT_PTR)SubMenu3, "Редактировать");
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        edit = CreateWindowExW(WS_EX_CLIENTEDGE, L"Edit", L"",
            ...
            15, 15, 800, 500, hwnd, (HMENU)ID_EDIT, NULL, NULL);
        MainWndAddMenu(hwnd);
        break;
    case WM_COMMAND:
        switch (wParam)
        ...
        case OnMenu2Clicked:
            ...
            break;
        case OnMenu3Clicked:
            MessageBox(hwnd, "Простой текстовый редактор\nРазработчик: Гусев Михаил, группа 606-11", "О программе", MB_OK);
            break;
        case ON_CUT:
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd;
    hwnd =
        CreateWindowEx(WS_EX_CLIENTEDGE, "myWindowClass", "Безымянный", WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN,
